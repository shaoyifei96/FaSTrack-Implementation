...
%save
%%
planner_data.p1_limit  = pMax(1);
planner_data.p2_limit = pMax(2);
save(['Dubin3D' num2str(gN(1)) '_dt0' num2str(dt*100) '_tMax_converge.mat'], 'TEB','sD', 'data','deriv','planner_data','-v7.3');
    %%
end
