...
t_move = 1; %making these values big will make the controller not work for some reason, there might be a bug
...
S = simulator(AB,W,P,'allow_replan_errors',true,'verbose',verbose_level,...
